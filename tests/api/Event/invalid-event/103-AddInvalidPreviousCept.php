...
/**
 * Try adding event with invalid previous attribute
 */
...
$I->wantTo('Try adding event with invalid previous attribute');
...
$I->seeResponseIsJson();
$I->seeResponseContains("broken chain; previous of 'BuizdWTtk7A6Xrt71i8Fy1npwE8x5KUVP4Q82xFGFFHy' is 'foo', expected 'Hm7W4Kprv52vfXoYmdG6Ee3pso6ruszaCLfJDxFotGjn'");
