...
/**
 * Try adding event with invalid signkey attribute to existing chain
 */
...
$I->wantTo('Try adding event with invalid signkey attribute to existing chain');
