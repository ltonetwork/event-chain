...
/**
 * Try adding event with no signature to existing chain
 */
...
$I->wantTo('Try adding event with no signature to existing chain');
...
$I->seeResponseIsJson();
$I->seeResponseContains("event 'HNYfjH39pUgo6d2ovbVoEmu2REmedsRAYAy6UxeuoKX6': signature is required");
...
$I->seeValidErrorEventInResponse(
    ["event 'HNYfjH39pUgo6d2ovbVoEmu2REmedsRAYAy6UxeuoKX6': signature is required"], 
